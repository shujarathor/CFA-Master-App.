    ...
    "Economics": {
        ...
        "MOCK EXAM": {
            "Full Mock": [
                ...
                {"q": "151. 'Information Asymmetry' leads to 'Adverse Selection' when:", "opt": ["One party has more info BEFORE the transaction", "One party has more info AFTER", "Both have equal info"], "ans": "One party has more info BEFORE the transaction", "why": "e.g., Sick people buying insurance."},
                {"q": "152. 'Moral Hazard' occurs when:", "opt": ["One party changes behavior AFTER the contract is signed", "Before the contract", "Prices are too high"], "ans": "One party changes behavior AFTER the contract is signed", "why": "e.g., Driving recklessly after buying insurance."},
                {"q": "153. 'Signaling' (e.g., a college degree) is a solution to:", "opt": ["Adverse Selection", "Moral Hazard", "Monopoly"], "ans": "Adverse Selection", "why": "The strong candidate signals quality to distinguish from the weak."},
                {"q": "154. 'Screening' is when the UNINFORMED party:", "opt": ["Sets a test to reveal info", "Hides info", "Guesses"], "ans": "Sets a test to reveal info", "why": "e.g., Insurance company offering a high-deductible plan to filter out high-risk types."},
                {"q": "155. In the 'Principal-Agent Problem', the conflict arises because:", "opt": ["Agents interests differ from Principals", "Principal has full info", "Agent is paid too much"], "ans": "Agents interests differ from Principals", "why": "e.g., Shareholders (Principal) vs Managers (Agent)."},
                {"q": "156. The 'Winner's Curse' in auctions suggests the winner often:", "opt": ["Overpays", "Underpays", "Gets a bargain"], "ans": "Overpays", "why": "To win, you must be the most optimistic bidder, usually exceeding true value."},
                {"q": "157. A 'Public Good' is defined by being:", "opt": ["Non-excludable and Non-rivalrous", "Excludable but Non-rivalrous", "Rivalrous"], "ans": "Non-excludable and Non-rivalrous", "why": "National Defense (everyone gets it, my use doesn't hurt yours)."},
                {"q": "158. A 'Common Resource' (Tragedy of the Commons) is:", "opt": ["Non-excludable but Rivalrous", "Excludable and Rivalrous", "Public Good"], "ans": "Non-excludable but Rivalrous", "why": "Ocean Fish (Hard to stop fishing, but if I catch one, you can't)."},
                {"q": "159. 'Club Goods' (Natural Monopolies) are:", "opt": ["Excludable but Non-rivalrous", "Non-excludable", "Rivalrous"], "ans": "Excludable but Non-rivalrous", "why": "Cable TV (Can shut it off, but my watching doesn't hurt you)."},
                {"q": "160. The 'Free Rider Problem' prevents private markets from supplying:", "opt": ["Public Goods", "Private Goods", "Club Goods"], "ans": "Public Goods", "why": "Nobody pays if they can get it for free."},
                {"q": "161. 'Logrolling' in politics creates inefficiency by:", "opt": ["Trading votes for special interest projects", "Reducing spending", "Increasing transparency"], "ans": "Trading votes for special interest projects", "why": "I vote for your pork-barrel project if you vote for mine."},
                {"q": "162. The 'Median Voter Theorem' suggests politicians will move toward:", "opt": ["The Center", "The Extremes", "The Left"], "ans": "The Center", "why": "To capture the majority vote."},
                {"q": "163. 'Regulatory Capture' occurs when:", "opt": ["Regulated firms control the regulator", "Regulator is too strict", "Consumers run the regulator"], "ans": "Regulated firms control the regulator", "why": "Agencies end up serving the industry they are meant to police."},
                {"q": "164. An 'External Debt' crisis is more likely if debt is denominated in:", "opt": ["Foreign Currency", "Domestic Currency", "Gold"], "ans": "Foreign Currency", "why": "You cannot print money to pay it off ('Original Sin')."},
                {"q": "165. 'Sovereign Default' differs from corporate default because:", "opt": ["There is no legal mechanism to liquidate a country", "Assets are seized immediately", "It never happens"], "ans": "There is no legal mechanism to liquidate a country", "why": "Creditors must negotiate (Haircuts)."},
                {"q": "166. 'Autarky' refers to:", "opt": ["Economic self-sufficiency (No trade)", "Free Trade", "Common Market"], "ans": "Economic self-sufficiency (No trade)", "why": "North Korea model."},
                {"q": "167. A 'Trade War' (Tit-for-Tat tariffs) results in:", "opt": ["Reduced Global Welfare", "One winner", "Higher growth"], "ans": "Reduced Global Welfare", "why": "Prisoner's Dilemma outcome: both defect."},
                {"q": "168. The 'Infant Industry' argument is valid only if:", "opt": ["The industry eventually becomes efficient", "Protection is permanent", "It is a monopoly"], "ans": "The industry eventually becomes efficient", "why": "Otherwise it is just permanent subsidy."},
                {"q": "169. 'Social Marginal Cost' equals:", "opt": ["Private Marginal Cost + External Cost", "Private Cost only", "External Cost only"], "ans": "Private Marginal Cost + External Cost", "why": "True cost to society (e.g., Factory cost + Pollution damage)."},
                {"q": "170. 'Coase Theorem' fails if:", "opt": ["Transaction costs are high", "Property rights are defined", "Few parties involved"], "ans": "Transaction costs are high", "why": "Bargaining becomes impossible."},
                {"q": "171. 'Command and Control' regulation is often less efficient than:", "opt": ["Market-based instruments (Cap and Trade)", "Banning production", "Doing nothing"], "ans": "Market-based instruments (Cap and Trade)", "why": "Doesn't equalize marginal abatement costs across firms."},
                {"q": "172. A 'Correction Tax' (Pigou) should be set equal to:", "opt": ["Marginal External Cost", "Total Cost", "Zero"], "ans": "Marginal External Cost", "why": "Internalizes the externality."},
                {"q": "173. 'Tradable Pollution Permits' sets the:", "opt": ["Quantity of pollution", "Price of pollution", "Technology used"], "ans": "Quantity of pollution", "why": "Market determines the price."},
                {"q": "174. The 'Prebisch-Singer Hypothesis' suggests developing nations suffer from:", "opt": ["Declining terms of trade for commodities", "Rising terms of trade", "Too much industry"], "ans": "Declining terms of trade for commodities", "why": "Raw material prices fall relative to manufactured goods over time."},
                {"q": "175. 'Import Substitution Industrialization' (ISI) strategy involves:", "opt": ["Blocking imports to build domestic industry", "Export promotion", "Free Trade"], "ans": "Blocking imports to build domestic industry", "why": "Often failed due to lack of competition."},
                {"q": "176. 'Export-Oriented Industrialization' (Asian Tigers) focuses on:", "opt": ["Competitiveness in global markets", "Self-sufficiency", "Tariffs"], "ans": "Competitiveness in global markets", "why": "Forces efficiency."},
                {"q": "177. 'Brain Drain' hurts developing nations by:", "opt": ["Losing human capital", "Increasing population", "Lowering wages"], "ans": "Losing human capital", "why": "Skilled workers leave for higher wages abroad."},
                {"q": "178. 'Remittances' are:", "opt": ["Funds sent home by foreign workers", "Govt Aid", "FDI"], "ans": "Funds sent home by foreign workers", "why": "Huge source of FX for developing nations."},
                {"q": "179. The 'Impossible Trinity' for the Eurozone means members gave up:", "opt": ["Independent Monetary Policy", "Free Capital Flow", "Fixed Exchange Rate"], "ans": "Independent Monetary Policy", "why": "They have fixed rates (Euro) and open capital, so ECB sets one rate for all."},
                {"q": "180. A 'Currency Board' is harder to break than a peg because:", "opt": ["It is legislated and requires 100% backing", "It is informal", "It floats"], "ans": "It is legislated and requires 100% backing", "why": "No discretionary money printing allowed."},
                {"q": "181. 'Base Money' (High Powered Money) includes:", "opt": ["Currency + Bank Reserves", "M1", "M2"], "ans": "Currency + Bank Reserves", "why": "The liability of the Central Bank."},
                {"q": "182. 'Broad Money' (M2/M3) includes:", "opt": ["Deposits created by private banks", "Only cash", "Only Reserves"], "ans": "Deposits created by private banks", "why": "Includes the multiplier effect."},
                {"q": "183. 'Credit Easing' differs from QE because it focuses on:", "opt": ["Changing the composition of CB assets (quality)", "Increasing the size of balance sheet", "Rates"], "ans": "Changing the composition of CB assets (quality)", "why": "Buying corporate bonds instead of treasuries to unfreeze specific markets."},
                {"q": "184. 'Yield Curve Control' (YCC) involves:", "opt": ["Pegging a long-term interest rate", "Pegging short rate", "Floating rates"], "ans": "Pegging a long-term interest rate", "why": "CB buys unlimited bonds to keep 10y yield at X%."},
                {"q": "185. A 'Liquidity Trap' is characterized by:", "opt": ["Horizontal LM curve", "Vertical LM curve", "Vertical IS curve"], "ans": "Horizontal LM curve", "why": "Money demand is infinite at the zero lower bound."},
                {"q": "186. In a Liquidity Trap, the most effective policy is:", "opt": ["Fiscal Policy", "Monetary Policy", "Austerity"], "ans": "Fiscal Policy", "why": "Monetary policy pushes on a string; Fiscal shifts IS right."},
                {"q": "187. 'Time Inconsistency' problem in policy means:", "opt": ["Policymakers have incentive to renege on promises", "Policy takes time to work", "Data is late"], "ans": "Policymakers have incentive to renege on promises", "why": "Promising low inflation, then printing money to boost employment."},
                {"q": "188. 'Central Bank Independence' solves Time Inconsistency by:", "opt": ["Insulating policy from short-term politics", "Letting politicians decide", " fixing rates"], "ans": "Insulating policy from short-term politics", "why": "Commitment device."},
                {"q": "189. 'Automatic Stabilizers' reduce the multiplier because:", "opt": ["Taxes rise in boom, fall in recession", "They increase spending in boom", "They are slow"], "ans": "Taxes rise in boom, fall in recession", "why": "Dampens the cycle without action."},
                {"q": "190. The 'Balanced Budget Multiplier' is 1 because:", "opt": ["G increases Y, T decreases Y, net is positive", "It is zero", "It is negative"], "ans": "G increases Y, T decreases Y, net is positive", "why": "Spending stimulates more than taxes suppress (MPC < 1)."},
                {"q": "191. 'Crowding In' (opposite of Out) can occur if:", "opt": ["Govt spending improves infrastructure/productivity", "Deficits are high", "Rates rise"], "ans": "Govt spending improves infrastructure/productivity", "why": "Public investment makes private investment more profitable."},
                {"q": "192. 'Ricardian Equivalence' fails if:", "opt": ["Consumers are myopic or credit constrained", "Consumers are rational", "Taxes are lump sum"], "ans": "Consumers are myopic or credit constrained", "why": "If people can't save/borrow freely, they spend the tax cut now."},
                {"q": "193. 'Supply-Side Economics' advocates:", "opt": ["Deregulation and Tax Cuts", "High Spending", "High Tariffs"], "ans": "Deregulation and Tax Cuts", "why": "To shift LRAS right."},
                {"q": "194. 'Demand-Pull Inflation' is caused by:", "opt": ["Too much money chasing too few goods", "Oil shock", "Wage hike"], "ans": "Too much money chasing too few goods", "why": "AD shifts right beyond potential."},
                {"q": "195. 'Built-in Inflation' (Wage-Price Spiral) is driven by:", "opt": ["Adaptive Expectations", "Supply shocks", "Deflation"], "ans": "Adaptive Expectations", "why": "Workers expect past inflation to continue, demanding higher wages."},
                {"q": "196. 'Hyperinflation' is almost always a result of:", "opt": ["Fiscal Dominance (Monetizing Debt)", "Oil shock", "Trade Deficit"], "ans": "Fiscal Dominance (Monetizing Debt)", "why": "Govt forces CB to print money to pay bills."},
                {"q": "197. 'Disinflation' vs 'Deflation':", "opt": ["Disinflation is slowing inflation rate; Deflation is negative", "They are same", "Disinflation is good"], "ans": "Disinflation is slowing inflation rate; Deflation is negative", "why": "Disinflation = Prices rising slower. Deflation = Prices falling."},
                ...
                {"q": "203. [CHART: Phillips] A move ALONG the Short-Run Phillips Curve (SRPC) to the left implies:", "opt": ["Lower Unemployment, Higher Inflation", "Higher Unemployment, Lower Inflation", "Stagflation"], "ans": "Lower Unemployment, Higher Inflation", "why": "Trade-off between inflation and unemployment in the short run.", "chart": "phillips_curve"},
                {"q": "204. [CHART: Laffer] According to the Laffer Curve, if the tax rate is to the right of the peak, cutting taxes will:", "opt": ["Increase Tax Revenue", "Decrease Tax Revenue", "Have no impact"], "ans": "Increase Tax Revenue", "why": "Rates are prohibitive; cutting them stimulates enough activity to offset the rate cut.", "chart": "laffer_curve"},
                {"q": "205. [CHART: IS-LM] If the IS Curve shifts Right (Fiscal Exp) while the LM Curve is vertical (Classical range), the result is:", "opt": ["Higher Rates, No Change in Output", "Higher Output, Same Rates", "Lower Rates"], "ans": "Higher Rates, No Change in Output", "why": "Full Crowding Out. Government spending just displaces private investment.", "chart": "is_lm"},
                {"q": "206. 'Giffen Good' demand curves slope upwards because:", "opt": ["Income Effect (Negative) > Substitution Effect (Negative)", "Income Effect (Positive) > Substitution Effect (Negative)", "Veblen effect"], "ans": "Income Effect (Positive) > Substitution Effect (Negative)", "why": "Inferior good where the income hit from a price rise forces you to buy MORE of it."},
                {"q": "207. 'Mosaic Theory' in Ethics allows analysts to use:", "opt": ["Material Non-Public Info", "Non-Material Non-Public Info + Public Info", "Insider tips"], "ans": "Non-Material Non-Public Info + Public Info", "why": "Combining small pieces of non-material info to form a conclusion is legal."},
                {"q": "208. 'Soft Dollar' standards require that brokerage commissions be used for:", "opt": ["Research and investment decision-making benefits", "Office rent", "Travel expenses"], "ans": "Research and investment decision-making benefits", "why": "Must directly benefit the client."},
                {"q": "209. If a CFA Charterholder forgets to renew their membership, they must:", "opt": ["Stop using the designation immediately", "Continue using it if they plan to pay", "Use 'CFA (Expired)'"], "ans": "Stop using the designation immediately", "why": "No pay, no say."},
                {"q": "210. In Hypothesis Testing, the 'Power of the Test' is:", "opt": ["1 - Probability of Type II Error", "Probability of Type I Error", "Confidence Level"], "ans": "1 - Probability of Type II Error", "why": "The probability of correctly rejecting a false null."},
                {"q": "211. A distribution with 'Leptokurtosis' (Fat Tails) implies:", "opt": ["Higher probability of extreme events", "Lower risk", "Normal distribution"], "ans": "Higher probability of extreme events", "why": "More 'black swan' risk than a normal curve."},
                {"q": "212. If Net Present Value (NPV) is positive, the Internal Rate of Return (IRR) must be:", "opt": ["Greater than the Cost of Capital (WACC)", "Less than WACC", "Equal to Zero"], "ans": "Greater than the Cost of Capital (WACC)", "why": "The project earns more than the hurdle rate."},
                {"q": "213. In the 'Porter’s 5 Forces' model, high barriers to exit lead to:", "opt": ["High industry rivalry", "Low rivalry", "High supplier power"], "ans": "High industry rivalry", "why": "Firms cannot leave easily, so they fight to the death during downturns."},
                {"q": "214. 'Put-Call Parity' formula is:", "opt": ["Call + Bond = Put + Stock", "Call - Put = Stock", "Call + Put = Stock + Bond"], "ans": "Call + Bond = Put + Stock", "why": "C + X/(1+r)^t = P + S. Fiduciary Call = Protective Put."},
                {"q": "215. 'Contango' in futures markets means:", "opt": ["Futures Price > Spot Price", "Spot > Futures", "Flat curve"], "ans": "Futures Price > Spot Price", "why": "Cost of carry implies future delivery is more expensive."},
                {"q": "216. A 'Eurodollar' is:", "opt": ["USD deposited outside the US", "Euro currency", "USD in Europe only"], "ans": "USD deposited outside the US", "why": "Not just Europe; any USD held in foreign banks."},
                {"q": "217. 'Duration' measures:", "opt": ["Sensitivity of Bond Price to Interest Rates", "Time to maturity", "Credit risk"], "ans": "Sensitivity of Bond Price to Interest Rates", "why": "Approximate % change in price for 1% change in yield."},
                {"q": "218. 'Convexity' is valuable to bondholders because:", "opt": ["Price rises more when rates fall than it drops when rates rise", "It increases yield", "It reduces duration"], "ans": "Price rises more when rates fall than it drops when rates rise", "why": "The price-yield curve is curved up; linear duration underestimates the gain."},
                {"q": "219. In a 'Waterfall' structure (Private Equity), the GP gets carried interest only after:", "opt": ["LPs receive their capital back + hurdle rate", "LPs receive capital back", "Immediately"], "ans": "LPs receive their capital back + hurdle rate", "why": "Protect the Limited Partners first."},
                {"q": "220. 'Survivorship Bias' in hedge fund indices causes returns to look:", "opt": ["Overstated", "Understated", "Accurate"], "ans": "Overstated", "why": "Failed funds drop out of the index, leaving only the winners."},
                {"q": "221. If Covariance is zero, Correlation is:", "opt": ["Zero", "One", "-1"], "ans": "Zero", "why": "Correlation = Covariance / (StdDev * StdDev)."},
                {"q": "222. The 'Chebyshev’s Inequality' states that for k=2 standard deviations, the minimum data retained is:", "opt": ["75%", "68%", "95%"], "ans": "75%", "why": "1 - (1/k^2) = 1 - 1/4 = 0.75. Valid for ANY distribution."},
                {"q": "223. 'Roy’s Safety First' ratio maximizes:", "opt": ["(Expected Return - Minimum Acceptable Return) / StdDev", "Sharpe Ratio", "Alpha"], "ans": "(Expected Return - Minimum Acceptable Return) / StdDev", "why": "Minimizes the probability of returns falling below the threshold."},
                {"q": "224. 'Behavioral Finance': Which bias involves holding losers too long and selling winners too soon?", "opt": ["Disposition Effect", "Confirmation Bias", "Gambler's Fallacy"], "ans": "Disposition Effect", "why": "Loss aversion makes us hate realizing a loss."},
                {"q": "225. A 'Stop-Loss Order' is used to:", "opt": ["Protect against downside risk", "Guarantee execution price", "Buy at the bottom"], "ans": "Protect against downside risk", "why": "Becomes a market order once the trigger price is hit."},
                {"q": "226. 'Dark Pools' are:", "opt": ["Private exchanges for institutional trading", "Illegal markets", "Night trading"], "ans": "Private exchanges for institutional trading", "why": "Provide liquidity without moving the market price immediately."},
                {"q": "227. In 'Dupont Analysis', ROE is broken down into:", "opt": ["Net Profit Margin x Asset Turnover x Leverage", "Net Income / Sales", "Assets / Equity"], "ans": "Net Profit Margin x Asset Turnover x Leverage", "why": "Efficiency x Productivity x Leverage."},
                {"q": "228. 'Free Cash Flow to Firm' (FCFF) is cash available to:", "opt": ["Both Debt and Equity holders", "Equity holders only", "Management"], "ans": "Both Debt and Equity holders", "why": "Before interest payments."},
                {"q": "229. If a bond is trading at a Premium, then:", "opt": ["Coupon Rate > YTM", "Coupon < YTM", "Coupon = YTM"], "ans": "Coupon Rate > YTM", "why": "Price is bid up until the yield drops to market levels."},
                {"q": "230. 'Securitization' turns illiquid assets (like mortgages) into:", "opt": ["Liquid tradable securities", "Fixed Assets", "Equity"], "ans": "Liquid tradable securities", "why": "Creates the MBS/ABS market."},
                {"q": "231. 'Tier 1 Capital' for banks consists primarily of:", "opt": ["Common Equity and Retained Earnings", "Subordinated Debt", "Loan Loss Reserves"], "ans": "Common Equity and Retained Earnings", "why": "The core capital to absorb losses."},
                {"q": "232. 'Basel III' regulations focus on:", "opt": ["Capital Adequacy, Leverage, and Liquidity", "Profit maximization", "Customer service"], "ans": "Capital Adequacy, Leverage, and Liquidity", "why": "Preventing another 2008 financial crisis."},
                {"q": "233. A 'Poison Pill' is a corporate defense strategy to:", "opt": ["Discourage hostile takeovers", "Bankrupt the company", "Pay dividends"], "ans": "Discourage hostile takeovers", "why": "Dilutes the acquirer's stake."},
                {"q": "234. 'Golden Parachute' refers to:", "opt": ["Lucrative severance package for executives", "Retirement plan", "Stock options"], "ans": "Lucrative severance package for executives", "why": "Often triggered by a takeover."},
                {"q": "235. 'ESG Investing' considers:", "opt": ["Environmental, Social, and Governance factors", "Earnings, Sales, Growth", "Equities, Stocks, Gold"], "ans": "Environmental, Social, and Governance factors", "why": "Sustainable investing."},
                {"q": "236. 'Greenwashing' is:", "opt": ["Misleading claims about environmental benefits", "Cleaning money", "Recycling"], "ans": "Misleading claims about environmental benefits", "why": "Marketing hype without substance."},
                {"q": "237. The 'Sharpe Ratio' measures:", "opt": ["Excess Return per unit of Total Risk (StdDev)", "Return per unit of Beta", "Absolute return"], "ans": "Excess Return per unit of Total Risk (StdDev)", "why": "Risk-adjusted performance."},
                {"q": "238. The 'Treynor Ratio' uses which risk measure?", "opt": ["Beta (Systematic Risk)", "Standard Deviation", "Variance"], "ans": "Beta (Systematic Risk)", "why": "Assumes the portfolio is well-diversified."},
                {"q": "239. 'Jensen's Alpha' measures:", "opt": ["Return in excess of CAPM prediction", "Total return", "Risk-free rate"], "ans": "Return in excess of CAPM prediction", "why": "The manager's skill (alpha) above the market exposure."},
                {"q": "240. 'Technical Analysis' assumes that:", "opt": ["Market prices discount all known info and trends persist", "Markets are random", "Fundamentals drive price"], "ans": "Market prices discount all known info and trends persist", "why": "Price action tells the story."},
                {"q": "241. A 'Head and Shoulders' pattern typically signals:", "opt": ["Reversal of an uptrend (Bearish)", "Continuation", "Bullish"], "ans": "Reversal of an uptrend (Bearish)", "why": "Failure to make a higher high."},
                {"q": "242. 'Bollinger Bands' measure:", "opt": ["Volatility", "Volume", "Momentum"], "ans": "Volatility", "why": "Standard deviation bands around a moving average."},
                {"q": "243. 'RSI' (Relative Strength Index) > 70 usually indicates:", "opt": ["Overbought", "Oversold", "Neutral"], "ans": "Overbought", "why": "Price may be due for a correction."},
                {"q": "244. 'Short Selling' involves:", "opt": ["Borrowing shares to sell high, buy low later", "Selling shares you own", "Buying puts"], "ans": "Borrowing shares to sell high, buy low later", "why": "Betting on a price decline."},
                {"q": "245. 'Margin Call' price formula: Price = Initial Price * (1-Initial Margin) / (1-Maintenance Margin). If bought at $100, 50% IM, 25% MM, call is at:", "opt": ["$66.67", "$50.00", "$75.00"], "ans": "$66.67", "why": "100 * 0.5 / 0.75 = 66.66."},
                {"q": "246. 'Operating Leverage' is high when:", "opt": ["Fixed Costs are high relative to Variable Costs", "Debt is high", "Sales are high"], "ans": "Fixed Costs are high relative to Variable Costs", "why": "Small change in sales leads to huge change in EBIT."},
                {"q": "247. 'Financial Leverage' is high when:", "opt": ["Debt is used to finance assets", "Fixed costs are high", "Equity is high"], "ans": "Debt is used to finance assets", "why": "Magnifies ROE (and risk)."},
                {"q": "248. The 'WACC' is the:", "opt": ["Weighted Average Cost of Capital", "Weighted Asset Cost", "Working Capital"], "ans": "Weighted Average Cost of Capital", "why": "The hurdle rate for firm investment."},
                {"q": "249. If Internal Rate of Return (IRR) conflicts with NPV:", "opt": ["Trust NPV", "Trust IRR", "Average them"], "ans": "Trust NPV", "why": "NPV assumes reinvestment at WACC (realistic); IRR assumes reinvestment at IRR (unrealistic)."},
                {"q": "250. 'Cannibalization' in capital budgeting refers to:", "opt": ["New project eating sales of existing product", "Competitors eating share", "Cost overruns"], "ans": "New project eating sales of existing product", "why": "Must subtract this lost revenue from the new project's cash flows."},
                {"q": "251. 'Sunk Costs' should be:", "opt": ["Ignored", "Included", "Depreciated"], "ans": "Ignored", "why": "Money is gone. Decision is based on future incremental cash flows."},
                {"q": "252. 'Working Capital' is:", "opt": ["Current Assets - Current Liabilities", "Total Assets - Total Debt", "Cash"], "ans": "Current Assets - Current Liabilities", "why": "Measures short-term liquidity."},
                {"q": "253. 'Days Sales Outstanding' (DSO) measures:", "opt": ["How fast customers pay", "Inventory turnover", "Payment to suppliers"], "ans": "How fast customers pay", "why": "Lower is better (cash in faster)."},
                {"q": "254. 'Inventory Turnover' = COGS / Average Inventory. A rising ratio means:", "opt": ["Efficiency or Stockouts", "Too much inventory", "Slow sales"], "ans": "Efficiency or Stockouts", "why": "Moving goods fast."},
                {"q": "255. 'Goodwill' is created when:", "opt": ["Acquisition price > Fair Value of Net Identifiable Assets", "Brand value rises", "Stock price rises"], "ans": "Acquisition price > Fair Value of Net Identifiable Assets", "why": "The premium paid for synergy/reputation."},
                {"q": "256. 'Impairment of Goodwill' must be tested:", "opt": ["Annually", "Never", "When stock falls"], "ans": "Annually", "why": "If fair value drops below book value, write it down."},
                {"q": "257. 'Deferred Tax Liability' (DTL) arises when:", "opt": ["Tax Expense (Book) > Tax Payable (IRS)", "Tax Payable > Tax Expense", "Losses occur"], "ans": "Tax Expense (Book) > Tax Payable (IRS)", "why": "You pay less tax now (depreciation rules) but will pay more later."},
                {"q": "258. 'Off-Balance Sheet' financing (Operating Leases under old rules) made firms look:", "opt": ["Less leveraged", "More leveraged", "Less profitable"], "ans": "Less leveraged", "why": "Debt wasn't recorded. (IFRS 16 now requires most leases on balance sheet)."},
                {"q": "259. 'Mark-to-Market' accounting means:", "opt": ["Assets are recorded at current fair value", "Historical cost", "Purchase price"], "ans": "Assets are recorded at current fair value", "why": "Relevant for trading securities."},
                {"q": "260. 'Basic EPS' vs 'Diluted EPS':", "opt": ["Diluted includes impact of options/convertibles", "Basic is always lower", "They are same"], "ans": "Diluted includes impact of options/convertibles", "why": "Conservative view: 'What if everyone converted their options?'"},
                {"q": "261. 'Common Size Financial Statements' express all items as:", "opt": ["Percentage of Sales (I/S) or Assets (B/S)", "Dollars", "Growth rates"], "ans": "Percentage of Sales (I/S) or Assets (B/S)", "why": "Allows comparison between companies of different sizes."},
                {"q": "262. 'Horizontal Analysis' compares:", "opt": ["Financial data over time", "Across companies", "Ratios"], "ans": "Financial data over time", "why": "Trend analysis."},
                {"q": "263. 'Vertical Analysis' compares:", "opt": ["Structure within one year (Common Size)", "Time trends", "Competitors"], "ans": "Structure within one year (Common Size)", "why": "Composition of assets/expenses."},
                {"q": "264. 'Sensitivity Analysis' changes:", "opt": ["One variable at a time", "Multiple variables", "Probability distributions"], "ans": "One variable at a time", "why": "See how robust the NPV is to a single risk factor."},
                {"q": "265. 'Scenario Analysis' changes:", "opt": ["Multiple variables consistent with a scenario (e.g., Recession)", "One variable", "Discount rate only"], "ans": "Multiple variables consistent with a scenario (e.g., Recession)", "why": "More realistic world-building."},
                {"q": "266. 'Monte Carlo Simulation' uses:", "opt": ["Probability distributions for inputs to generate output distribution", "Fixed inputs", "Linear trends"], "ans": "Probability distributions for inputs to generate output distribution", "why": "Thousands of trials to find probability of failure."},
                {"q": "267. 'Real Options' in capital budgeting give managers:", "opt": ["Flexibility to expand/abandon projects later", "Obligation to invest", "Fixed returns"], "ans": "Flexibility to expand/abandon projects later", "why": "Value of waiting/flexibility is added to NPV."},
                {"q": "268. 'Agency Costs' are minimized by:", "opt": ["Aligning management comp with shareholder value (Stock options)", "Paying high salaries", "Ignoring shareholders"], "ans": "Aligning management comp with shareholder value (Stock options)", "why": "Skin in the game."},
                {"q": "269. 'Corporate Governance' defines:", "opt": ["Rights and responsibilities of Board, Management, and Stakeholders", "Govt laws", "Tax rules"], "ans": "Rights and responsibilities of Board, Management, and Stakeholders", "why": "System of control."},
                {"q": "270. A 'Staggered Board' (Classified Board) makes it harder to:", "opt": ["Take over the company", "Hire a CEO", "Pay dividends"], "ans": "Take over the company", "why": "Only a fraction of directors are up for election each year."},
                {"q": "271. 'Share Repurchases' (Buybacks) generally:", "opt": ["Increase EPS", "Decrease EPS", "Lower stock price"], "ans": "Increase EPS", "why": "Reduces share count. (Earnings / Fewer Shares)."},
                {"q": "272. 'Stock Splits':", "opt": ["Do not change wealth, just share count", "Make you richer", "Increase market cap"], "ans": "Do not change wealth, just share count", "why": "Pizza cut into more slices."},
                {"q": "273. 'Dividend Irrelevance Theory' (Modigliani-Miller) states:", "opt": ["Value depends on earnings power, not payout policy", "Dividends are bad", "Dividends are good"], "ans": "Value depends on earnings power, not payout policy", "why": "In a perfect market, you can create your own dividend by selling shares."},
                {"q": "274. 'Clientele Effect':", "opt": ["Investors prefer stocks that match their tax/income needs", "Brokers control prices", "Marketing"], "ans": "Investors prefer stocks that match their tax/income needs", "why": "Retirees like high dividends; Growth investors like buybacks."},
                {"q": "275. 'Ex-Dividend Date': If you buy on this date, you:", "opt": ["Do NOT get the dividend", "Get the dividend", "Pay double"], "ans": "Do NOT get the dividend", "why": "You must buy BEFORE the Ex-date to record ownership."},
                {"q": "276. 'Bond Indenture':", "opt": ["Legal contract specifying terms and covenants", "The coupon", "The rating"], "ans": "Legal contract specifying terms and covenants", "why": "The rulebook for the bond."},
                {"q": "277. 'Affirmative Covenants':", "opt": ["Things the issuer MUST do (e.g., pay taxes, insure assets)", "Things they cannot do", "Optional"], "ans": "Things the issuer MUST do (e.g., pay taxes, insure assets)", "why": "Positive obligations."},
                {"q": "278. 'Negative Covenants':", "opt": ["Restrictions (e.g., no more debt, no mergers)", "Bad news", "Penalties"], "ans": "Restrictions (e.g., no more debt, no mergers)", "why": "Protect bondholders from risk-shifting."},
                {"q": "279. 'Yield to Worst' (YTW):", "opt": ["Lowest possible yield (YTM or Yield to Call)", "Highest yield", "Average yield"], "ans": "Lowest possible yield (YTM or Yield to Call)", "why": "Conservative metric for callable bonds."},
                {"q": "280. 'Zero-Coupon Bond' has:", "opt": ["High Duration and Volatility", "Low Duration", "High Coupon"], "ans": "High Duration and Volatility", "why": "Duration = Maturity. No coupons to dampen the rate sensitivity."},
                {"q": "281. 'Floating Rate Note' (FRN) has:", "opt": ["Very low duration", "High duration", "Fixed coupon"], "ans": "Very low duration", "why": "Coupon resets periodically, resetting price to par."},
                {"q": "282. 'Credit Spread' widens when:", "opt": ["Economic outlook worsens", "Economy booms", "Rates fall"], "ans": "Economic outlook worsens", "why": "Flight to safety (Treasuries)."},
                {"q": "283. 'Z-Spread' (Zero-volatility spread):", "opt": ["Spread over the entire Treasury spot curve", "Spread over one bond", "Nominal spread"], "ans": "Spread over the entire Treasury spot curve", "why": "More accurate than simple yield spread."},
                {"q": "284. 'OAS' (Option Adjusted Spread):", "opt": ["Z-Spread minus Option Cost", "Z-Spread plus Option", "Yield"], "ans": "Z-Spread minus Option Cost", "why": "Removes the value of the call option to isolate credit risk."},
                {"q": "285. 'Repo Market' (Repurchase Agreement):", "opt": ["Short-term collateralized lending", "Stock market", "Long term bonds"], "ans": "Short-term collateralized lending", "why": "Sell asset, agree to buy back tomorrow at higher price (implied interest)."},
                {"q": "286. 'Haircut' in Repo:", "opt": ["Difference between collateral value and loan amount", "Fee", "Interest"], "ans": "Difference between collateral value and loan amount", "why": "Protection against collateral value drop."},
                {"q": "287. 'ETFs' differ from Mutual Funds because:", "opt": ["They trade intraday like stocks", "They calculate NAV once a day", "They are active only"], "ans": "They trade intraday like stocks", "why": "Liquidity advantage."},
                {"q": "288. 'Open-End Fund':", "opt": ["Issues/Redeems shares at NAV daily", "Fixed number of shares", "Trades on exchange"], "ans": "Issues/Redeems shares at NAV daily", "why": "Can grow or shrink infinitely."},
                {"q": "289. 'Closed-End Fund':", "opt": ["Fixed shares, can trade at premium/discount to NAV", "Open shares", "Always at NAV"], "ans": "Fixed shares, can trade at premium/discount to NAV", "why": "Supply/Demand for shares drives price, not just assets."},
                {"q": "290. 'Hedge Fund' fee structure '2 and 20' means:", "opt": ["2% Mgmt Fee, 20% Performance Fee", "20% Mgmt, 2% Perf", "Flat fee"], "ans": "2% Mgmt Fee, 20% Performance Fee", "why": "Standard (though declining) model."},
                {"q": "291. 'High Water Mark':", "opt": ["Manager only gets perf fee if value exceeds highest previous peak", "Highest stock price", "Liquidity metric"], "ans": "Manager only gets perf fee if value exceeds highest previous peak", "why": "Prevents double-charging for recovering losses."},
                {"q": "292. 'Private Equity' value creation comes from:", "opt": ["Financial Engineering, Operational Improvements, Multiple Expansion", "Trading", "Dividends"], "ans": "Financial Engineering, Operational Improvements, Multiple Expansion", "why": "The PE playbook."},
                {"q": "293. 'Commodities' as an asset class provide:", "opt": ["Inflation Hedge and Diversification", "Income (Coupons)", "Steady growth"], "ans": "Inflation Hedge and Diversification", "why": "Low correlation with stocks/bonds."},
                {"q": "294. 'Backwardation' in commodities:", "opt": ["Spot > Futures", "Futures > Spot", "Flat"], "ans": "Spot > Futures", "why": "Benefit from 'Roll Yield' (buying cheap futures that roll up to spot)."},
                {"q": "295. 'REITs' (Real Estate Investment Trusts):", "opt": ["Liquid way to invest in real estate", "Illiquid", "Private only"], "ans": "Liquid way to invest in real estate", "why": "Trade like stocks, hold buildings."},
                {"q": "296. 'Brownfield' vs 'Greenfield' infrastructure:", "opt": ["Brownfield is existing assets; Greenfield is new construction", "Opposite", "Colors"], "ans": "Brownfield is existing assets; Greenfield is new construction", "why": "Brownfield has history/cash flow; Greenfield has construction risk."},
                {"q": "297. 'Collectibles' (Art, Wine) suffer from:", "opt": ["High transaction costs, Illiquidity, No income", "Low returns", "Volatility"], "ans": "High transaction costs, Illiquidity, No income", "why": "Pure capital appreciation play."},
                {"q": "298. 'Soft Commodities':", "opt": ["Grown (Coffee, Sugar, Corn)", "Mined (Gold)", "Oil"], "ans": "Grown (Coffee, Sugar, Corn)", "why": "Weather dependent."},
                {"q": "299. 'Hard Commodities':", "opt": ["Mined/Extracted (Gold, Oil)", "Grown", "Cattle"], "ans": "Mined/Extracted (Gold, Oil)", "why": "Geology dependent."},
                {"q": "300. [THE FINAL BOSS] 'Mosaic Theory' Violation? Analyst talks to CEO (Non-Material), talks to Suppliers (Non-Material), and checks Satellite Data (Public). Concludes earnings will beat. Trades.", "opt": ["Legal (Mosaic Theory)", "Illegal (Insider Trading)", "Illegal (Front Running)"], "ans": "Legal (Mosaic Theory)", "why": "Congratulations. You combined non-material non-public info with public info to create a material conclusion. This is the essence of active management."}
                        ]
        }
    }
}
