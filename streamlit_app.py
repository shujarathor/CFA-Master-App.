    ...
    "Economics": {
        ...
        "MOCK EXAM": {
            "Full Mock": [
                ...
                {"q": "19. If the USD/CAD spot is 1.30 and the 1-year forward is 1.28, the CAD is trading at a:", "opt": ["Forward Discount", "Forward Premium", "Par"], "ans": "Forward Premium", "why": "It takes FEWER CAD to buy a USD in future? No, wait. 1.30 CAD/USD -> 1.28 CAD/USD. CAD is getting stronger (Appreciating). Premium."},
